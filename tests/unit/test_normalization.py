...
from data_pipeline.transform.normalization import encode_categoricals  # noqa: E402
...
def test_region_colonnes_presentes(df_francais):
    """Les colonnes region_northwest/southeast/southwest doivent être présentes."""
    result = encode_categoricals(df_francais)
